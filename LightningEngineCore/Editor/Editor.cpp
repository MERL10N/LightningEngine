...
bool CEditor::Init(MTL::Device* device, MTK::View* view)
{
    ...
    mainFont = io.Fonts->AddFontFromFileTTF("/Volumes/T9/LightningEngine/LightningEngineCore/Fonts/AovelSansRounded-rdDL.ttf", 16.f, nullptr, io.Fonts->GetGlyphRangesJapanese());
