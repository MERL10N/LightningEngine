/*
    ...
    Generated by Kian Marvi on 6/26/24.
*/
...
NS::Menu* MetalApplication::createMenuBar()
{
...
void MetalApplication::applicationWillFinishLaunching( NS::Notification* notification )
{
...
void MetalApplication::applicationDidFinishLaunching( NS::Notification* notification )
{
...
bool MetalApplication::applicationShouldTerminateAfterLastWindowClosed( NS::Application* sender )
{
    return true;
}
