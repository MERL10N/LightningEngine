...
void CEditor::Render(MTL::RenderPassDescriptor *renderPassDescriptor, MTL::CommandBuffer *metalCommandBuffer, MTL::RenderCommandEncoder *renderCommandEncoder)
{
    ...
    ImGui::NewFrame();
        ...
        ImGui::Begin("Welcome to Lightning Engine!");                          // Create a window called "Welcome to Lightning Engine!" and append into it.

        ImGui::Text("This is a metal game engine written in C++");               // Display some text
